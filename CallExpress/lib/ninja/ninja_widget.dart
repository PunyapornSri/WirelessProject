...
import '../ninjapre/ninjapre_widget.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class NinjaWidget extends StatefulWidget {
  const NinjaWidget({Key key}) : super(key: key);

  @override
  _NinjaWidgetState createState() => _NinjaWidgetState();
}

class _NinjaWidgetState extends State<NinjaWidget> {
            ...
            children: [
              Stack(
                children: [
                  ...
                  Align(
                    alignment: AlignmentDirectional(0.1, 1.61),
                    child: Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(30, 50, 0, 0),
                      child: FFButtonWidget(
                        onPressed: () async {
                          await launchURL(
                              'http://dpostinter.thailandpost.com/Login');
                        },
                        text: 'BOOKING',
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => NinjapreWidget(),
                        ),
                      );
                    },
                    text: 'BOOKING',
