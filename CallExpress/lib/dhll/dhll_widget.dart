import '../dhlpre/dhlpre_widget.dart';
...
class DhllWidget extends StatefulWidget {
  const DhllWidget({Key key}) : super(key: key);

  @override
  _DhllWidgetState createState() => _DhllWidgetState();
}

class _DhllWidgetState extends State<DhllWidget> {
